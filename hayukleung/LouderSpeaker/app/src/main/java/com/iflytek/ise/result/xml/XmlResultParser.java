      ...
      while (XmlPullParser.END_DOCUMENT != eventType) {
        switch (eventType) {
          case XmlPullParser.START_TAG:
            ...
            } else if ("read_sentence".equals(pullParser.getName()) || "read_chapter".equals(
                pullParser.getName())) {
              if (!rec_paperPassed) {
          ...
          case XmlPullParser.END_TAG:
            ...
            } else if ("read_syllable".equals(pullParser.getName()) || "read_word".equals(
                pullParser.getName()) || "read_sentence".equals(pullParser.getName())) {
              return result;
            }
            break;
