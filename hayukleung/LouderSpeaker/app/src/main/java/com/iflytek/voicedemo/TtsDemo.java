...
import com.hayukleung.louderspeaker.R;
...
public class TtsDemo extends Activity implements OnClickListener {
  ...
  // 默认发音人
  private String mVoiceSpeaker = "xiaoyan";
  private String[] mCloudVoiceSpeakerEntries;
  private String[] mCloudVoiceSpeakerValue;
  // 缓冲进度
  ...
  @SuppressLint("ShowToast") public void onCreate(Bundle savedInstanceState) {
    ...
    // 云端发音人名称列表
    mCloudVoiceSpeakerEntries = getResources().getStringArray(R.array.voicer_cloud_entries);
    mCloudVoiceSpeakerValue = getResources().getStringArray(R.array.voicer_cloud_values);
  ...
  private void setParam() {
    ...
    if (mEngineType.equals(SpeechConstant.TYPE_CLOUD)) {
      ...
      // 设置在线合成发音人
      mTts.setParameter(SpeechConstant.VOICE_NAME, mVoiceSpeaker);
      // 设置合成语速
      ...
      // 设置本地合成发音人 voice speaker 为空，默认通过语记界面指定发音人。
    ...
    switch (mRadioGroup.getCheckedRadioButtonId()) {
      ...
      case R.id.tts_radioCloud:
        new AlertDialog.Builder(this).setTitle("在线合成发音人选项")
            .setSingleChoiceItems(mCloudVoiceSpeakerEntries, // 单选框有几项,各是什么名字
                selectedNum, // 默认的选项
                new DialogInterface.OnClickListener() { // 点击单选框后的处理
                  public void onClick(DialogInterface dialog, int which) { // 点击了哪一项
                    mVoiceSpeaker = mCloudVoiceSpeakerValue[which];
                    if ("catherine".equals(mVoiceSpeaker)
                        || "henry".equals(mVoiceSpeaker)
                        || "vimary".equals(mVoiceSpeaker)) {
