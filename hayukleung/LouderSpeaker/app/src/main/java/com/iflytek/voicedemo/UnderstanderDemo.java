...
public class UnderstanderDemo extends Activity implements OnClickListener {
  ...
  private SpeechUnderstanderListener mSpeechUnderstanderListener =
      new SpeechUnderstanderListener() {
  ...
  @SuppressLint("ShowToast") public void onCreate(Bundle savedInstanceState) {
    ...
    // 初始化对象
    mSpeechUnderstander =
        SpeechUnderstander.createUnderstander(UnderstanderDemo.this, mSpeechUdrInitListener);
    mTextUnderstander =
        TextUnderstander.createTextUnderstander(UnderstanderDemo.this, mTextUdrInitListener);
  ...
  private void initLayout() {
    ...
    mSharedPreferences =
        getSharedPreferences(UnderstanderSettings.PREFER_NAME, Activity.MODE_PRIVATE);
  }
  ...
  public void setParam() {
    ...
    mSpeechUnderstander.setParameter(SpeechConstant.ASR_PTT,
        mSharedPreferences.getString("understander_punc_preference", "1"));
